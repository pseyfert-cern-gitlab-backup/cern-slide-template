...
\IfFileExists{/usr/local/share/fonts/PragmataPro/PragmataPro_Mono_R_0827.ttf}{\setmonofont{PragmataPro}[Scale=MatchLowercase]}{}
...
%   }
%
% % usage: \LabelSubSec{foo} \subsection{bar} \ref{foo}
